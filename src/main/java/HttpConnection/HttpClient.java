        ...
        try {
            ...
            if (method == HttpRequestMethod.POST || method == HttpRequestMethod.PUT) {
                ...
                if (params.hasFiles()) {
                    ...
                    byte[] content = toEncodedJSONString(params).getBytes();
//                    System.out.println(params.stringEntrySet().toString());
    ...
    private String toEncodedJSONString(RequestParams params){
        // If the PARAMS object already has a JSON string saved, it means we don't need to encode anything here
        if(params.getJsonParams() != null)
    ...
    public void setBasicAuth(String username, String password) {
        ...
        String encoded = jakarta.xml.bind.DatatypeConverter.printBase64Binary((username + ":" + password).getBytes());
