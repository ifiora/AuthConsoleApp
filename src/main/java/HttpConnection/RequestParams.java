...
public class RequestParams {
    ...
    private String jsonParams; // JSON that comes already formed
    ...
    /**
     * Create a RequestParams object with an initial json String parameter.
     *
     * @param jsonString
     */
    public RequestParams(String jsonString) {
        this();
    ...
    /**
     * Set a new JSON String parameter or overwrite the existing one.
     *
     * @param jsonString
     */
